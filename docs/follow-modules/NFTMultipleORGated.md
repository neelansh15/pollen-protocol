# NFT Multiple OR Gated

Allow follow if the user holds **at least one** of the ERC721 NFTs set by the profile owner.

## Deployments

```yaml
Goerli: 0xfe7edfd1f26ba468f3075702c907d76f5a96e28c
```
